<form id="healthInfoForm" action="">
    ...
    <div class="pl-input-container">
        ...
        <textarea id="warnings" name="warnings" rows="3" placeholder="Enter any warnings or special notes"></textarea>
    </div>
    ...
    <div class="pl-input-container conditional-grooming-notes" style="display: none;">
        <label for="groomingDetails">Grooming instructions & notes:
            <textarea id="groomingDetails" name="groomingDetails" rows="3" placeholder="Enter grooming instructions"></textarea>
        </label>
    </div>
</form>